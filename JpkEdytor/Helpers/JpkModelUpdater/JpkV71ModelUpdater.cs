namespace JpkEdytor.Helpers.JpkModelUpdater
{
    ...
    using Models.V71;
    using Models.V71.Common;

    public abstract class JpkV71ModelUpdater<T> : JpkModelUpdater<T> where T : IJpkV71
    {
        ...
        protected virtual void UpdateSprzedazWiersze(IEnumerable<EwidencjaSprzedazWierszBase> sprzedazWiersze)
        {
            ...
            foreach(var sprzedazWiersz in sprzedazWiersze)
            {
                ...
                sprzedazWiersz.SwSpecified = !IsDefaultValue(sprzedazWiersz.Sw);
                sprzedazWiersz.EeSpecified = !IsDefaultValue(sprzedazWiersz.Ee);
                ...
                sprzedazWiersz.MppSpecified = !IsDefaultValue(sprzedazWiersz.Mpp);

                sprzedazWiersz.KorektaPodstawyOpodatkowaniaSpecified = !IsDefaultValue(sprzedazWiersz.KorektaPodstawyOpodatkowania);
        ...
        protected virtual void UpdateZakupWiersze(IEnumerable<EwidencjaZakupWierszBase> zakupWiersze)
        {
            ...
            foreach(var zakupWiersz in zakupWiersze)
            {
                ...
                zakupWiersz.MppSpecified = !IsDefaultValue(zakupWiersz.Mpp);
