namespace JpkEdytor.Models.Common
{
    ...
    [Serializable]
    [XmlType(TypeName = "TIdentyfikatorOsobyNiefizycznej", Namespace = "http://crd.gov.pl/xml/schematy/dziedzinowe/mf/2016/01/25/eD/DefinicjeTypy/")]
    public sealed class IdentyfikatorOsobyNiefizycznejV40 : NotifyPropertyChanged
    {
        private string nip;
