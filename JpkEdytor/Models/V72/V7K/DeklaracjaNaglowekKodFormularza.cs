namespace JpkEdytor.Models.V72.V7K
{
    ...
    [Serializable]
    [XmlType(TypeName = "JPKDeklaracjaNaglowekKodFormularzaDekl", AnonymousType = true, Namespace = "http://crd.gov.pl/wzor/2021/07/08/07082/")]
    public sealed class DeklaracjaNaglowekKodFormularza : NotifyPropertyChanged
    {
        ...
        {
            KodSystemowy = "VAT-7K (16)";
            KodPodatku = "VAT";
            RodzajZobowiazania = "Z";
            WersjaSchemy = "1-0E";
            KodFormularza = "VAT-7K";
        }
