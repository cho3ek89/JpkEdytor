namespace JpkEdytor.Models.V72.Common
{
    ...
    public abstract class EwidencjaSprzedazWierszBase : NotifyPropertyChanged
    {
        ...
        private sbyte wstoEe;

        private bool wstoEeSpecified;

        private sbyte ied;

        private bool iedSpecified;
        ...
        private bool dataKorektySpecified;

        private TypDatyKorekty typDatyKorekty;

        private bool typDatyKorektySpecified;
        ...
        [XmlElement(ElementName = "WSTO_EE")]
        public sbyte WstoEe
        {
            get
            {
        ...
        [XmlIgnore]
        [XmlElement(ElementName = "WSTO_EESpecified", DataType = "boolean")]
        public bool WstoEeSpecified
        {
            get
            {
                return wstoEeSpecified;
            }
            set
            {
                wstoEeSpecified = value;
                RaisePropertyChanged();
            }
        }

        [XmlElement(ElementName = "IED")]
        public sbyte Ied
        {
            get
            {
        ...
        [XmlIgnore]
        [XmlElement(ElementName = "IEDSpecified", DataType = "boolean")]
        ...
        [XmlElement(ElementName = "DataZaplaty", DataType = "date")]
        [XmlElement(ElementName = "TerminPlatnosci", DataType = "date")]
        [XmlChoiceIdentifier(MemberName = "TypDatyKorekty")]
        ...
        public bool DataKorektySpecified
        {
            get
            {
                return dataKorektySpecified;
            }
            set
            {
                dataKorektySpecified = value;
                RaisePropertyChanged();
            }
        }

        [XmlIgnore]
        [XmlElement(ElementName = "ItemElementName")]
        public TypDatyKorekty TypDatyKorekty
        {
            get
            {
                return typDatyKorekty;
            }
            set
            {
                typDatyKorekty = value;
                RaisePropertyChanged();
            }
        }
        ...
        [XmlIgnore]
        [XmlElement(DataType = "boolean")]
        public bool TypDatyKorektySpecified
        {
            get
            {
                return typDatyKorektySpecified;
            }
            set
            {
                typDatyKorektySpecified = value;
                RaisePropertyChanged();
            }
        }
