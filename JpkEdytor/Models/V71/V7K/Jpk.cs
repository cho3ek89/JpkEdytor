namespace JpkEdytor.Models.V71.V7K
{
    ...
    [Serializable]
    [XmlType(AnonymousType = true, Namespace = "http://crd.gov.pl/wzor/2020/05/08/9394/")]
    [XmlRoot(ElementName = "JPK", Namespace = "http://crd.gov.pl/wzor/2020/05/08/9394/", IsNullable = false)]
    public sealed class Jpk : NotifyPropertyChanged, IJpkV71
    {
