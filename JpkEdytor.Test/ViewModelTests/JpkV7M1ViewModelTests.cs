namespace JpkEdytor.Tests.ViewModelTests
{
    ...
    public class JpkV7M1ViewModelTests : ViewModelTestsBase
    {
        ...
        [DataRow(true, false, false, false, "TestFiles/jpk_v7m1_valid_empty_osoba_fizyczna.xml", DisplayName = "Empty; osoba fizyczna")]
        [DataRow(false, true, false, false, "TestFiles/jpk_v7m1_valid_deklaracja_osoba_niefizyczna.xml", DisplayName = "With deklaracja; osoba niefizyczna")]
        [DataRow(true, true, false, false, "TestFiles/jpk_v7m1_valid_deklaracja_osoba_fizyczna.xml", DisplayName = "With deklaracja; osoba fizyczna")]
        [DataRow(false, false, true, false, "TestFiles/jpk_v7m1_valid_sprzedaz_osoba_niefizyczna.xml", DisplayName = "With sprzedaz; osoba niefizyczna")]
        [DataRow(true, false, true, false, "TestFiles/jpk_v7m1_valid_sprzedaz_osoba_fizyczna.xml", DisplayName = "With sprzedaz; osoba fizyczna")]
        [DataRow(false, true, true, false, "TestFiles/jpk_v7m1_valid_deklaracja_sprzedaz_osoba_niefizyczna.xml", DisplayName = "With deklaracja, sprzedaz; osoba niefizyczna")]
        [DataRow(true, true, true, false, "TestFiles/jpk_v7m1_valid_deklaracja_sprzedaz_osoba_fizyczna.xml", DisplayName = "With deklaracja, sprzedaz; osoba fizyczna")]
        [DataRow(false, false, false, true, "TestFiles/jpk_v7m1_valid_zakupy_osoba_niefizyczna.xml", DisplayName = "With zakupy; osoba niefizyczna")]
        [DataRow(true, false, false, true, "TestFiles/jpk_v7m1_valid_zakupy_osoba_fizyczna.xml", DisplayName = "With zakupy; osoba fizyczna")]
        [DataRow(false, true, false, true, "TestFiles/jpk_v7m1_valid_deklaracja_zakupy_osoba_niefizyczna.xml", DisplayName = "With deklaracja, zakupy; osoba niefizyczna")]
        [DataRow(true, true, false, true, "TestFiles/jpk_v7m1_valid_deklaracja_zakupy_osoba_fizyczna.xml", DisplayName = "With deklaracja, zakupy; osoba fizyczna")]
        [DataRow(false, false, true, true, "TestFiles/jpk_v7m1_valid_sprzedaz_zakupy_osoba_niefizyczna.xml", DisplayName = "With sprzedaz, zakupy; osoba niefizyczna")]
