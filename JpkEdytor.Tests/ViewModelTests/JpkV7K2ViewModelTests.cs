namespace JpkEdytor.Tests.ViewModelTests
{
    ...
    using JpkEdytor.Models.V72.V7K;
    using JpkEdytor.ViewModels;

    [TestClass]
    public class JpkV7K2ViewModelTests
    {
        [DataTestMethod]
        [DataRow(false, false, false, false, "TestFiles/jpk_v7k2_valid_empty_osoba_niefizyczna.xml", DisplayName = "JPK_V7K(2) - Empty; osoba niefizyczna")]
        [DataRow(true, false, false, false, "TestFiles/jpk_v7k2_valid_empty_osoba_fizyczna.xml", DisplayName = "JPK_V7K(2) - Empty; osoba fizyczna")]
        [DataRow(false, true, false, false, "TestFiles/jpk_v7k2_valid_deklaracja_osoba_niefizyczna.xml", DisplayName = "JPK_V7K(2) - With deklaracja; osoba niefizyczna")]
        [DataRow(true, true, false, false, "TestFiles/jpk_v7k2_valid_deklaracja_osoba_fizyczna.xml", DisplayName = "JPK_V7K(2) - With deklaracja; osoba fizyczna")]
        [DataRow(false, false, true, false, "TestFiles/jpk_v7k2_valid_sprzedaz_osoba_niefizyczna.xml", DisplayName = "JPK_V7K(2) - With sprzedaz; osoba niefizyczna")]
        [DataRow(true, false, true, false, "TestFiles/jpk_v7k2_valid_sprzedaz_osoba_fizyczna.xml", DisplayName = "JPK_V7K(2) - With sprzedaz; osoba fizyczna")]
        [DataRow(false, true, true, false, "TestFiles/jpk_v7k2_valid_deklaracja_sprzedaz_osoba_niefizyczna.xml", DisplayName = "JPK_V7K(2) - With deklaracja, sprzedaz; osoba niefizyczna")]
        [DataRow(true, true, true, false, "TestFiles/jpk_v7k2_valid_deklaracja_sprzedaz_osoba_fizyczna.xml", DisplayName = "JPK_V7K(2) - With deklaracja, sprzedaz; osoba fizyczna")]
        [DataRow(false, false, false, true, "TestFiles/jpk_v7k2_valid_zakupy_osoba_niefizyczna.xml", DisplayName = "JPK_V7K(2) - With zakupy; osoba niefizyczna")]
        [DataRow(true, false, false, true, "TestFiles/jpk_v7k2_valid_zakupy_osoba_fizyczna.xml", DisplayName = "JPK_V7K(2) - With zakupy; osoba fizyczna")]
        [DataRow(false, true, false, true, "TestFiles/jpk_v7k2_valid_deklaracja_zakupy_osoba_niefizyczna.xml", DisplayName = "JPK_V7K(2) - With deklaracja, zakupy; osoba niefizyczna")]
        [DataRow(true, true, false, true, "TestFiles/jpk_v7k2_valid_deklaracja_zakupy_osoba_fizyczna.xml", DisplayName = "JPK_V7K(2) - With deklaracja, zakupy; osoba fizyczna")]
        [DataRow(false, false, true, true, "TestFiles/jpk_v7k2_valid_sprzedaz_zakupy_osoba_niefizyczna.xml", DisplayName = "JPK_V7K(2) - With sprzedaz, zakupy; osoba niefizyczna")]
        [DataRow(true, false, true, true, "TestFiles/jpk_v7k2_valid_sprzedaz_zakupy_osoba_fizyczna.xml", DisplayName = "JPK_V7K(2) - With sprzedaz, zakupy; osoba fizyczna")]
        [DataRow(false, true, true, true, "TestFiles/jpk_v7k2_valid_deklaracja_sprzedaz_zakupy_osoba_niefizyczna.xml", DisplayName = "JPK_V7K(2) - With deklaracja, sprzedaz, zakupy; osoba niefizyczna")]
        [DataRow(true, true, true, true, "TestFiles/jpk_v7k2_valid_deklaracja_sprzedaz_zakupy_osoba_fizyczna.xml", DisplayName = "JPK_V7K(2) - With deklaracja, sprzedaz, zakupy; osoba fizyczna")]
        [Description("Checks if JPK_V7K(2) files are generated properly.")]
        public async Task JpkV7K2FilesAreGeneratedProperly(bool osobaFizyczna, bool appendDeklaracja, bool appendSprzedaz, bool appendZakupy, string expectedFullFilePath)
        {
            var vm = new JpkV7K2ViewModel();
            var jpk = vm.Jpk;
