namespace JpkEdytor.Tests.ViewModelTests
{
    ...
    using JpkEdytor.Models.V71.V7M;
    ...
    {
        [DataTestMethod]
        [DataRow(false, false, false, false, "TestFiles/jpk_v7m1_valid_empty_osoba_niefizyczna.xml", DisplayName = "JPK_V7M(1) - Empty; osoba niefizyczna")]
        [DataRow(true, false, false, false, "TestFiles/jpk_v7m1_valid_empty_osoba_fizyczna.xml", DisplayName = "JPK_V7M(1) - Empty; osoba fizyczna")]
        [DataRow(false, true, false, false, "TestFiles/jpk_v7m1_valid_deklaracja_osoba_niefizyczna.xml", DisplayName = "JPK_V7M(1) - With deklaracja; osoba niefizyczna")]
        [DataRow(true, true, false, false, "TestFiles/jpk_v7m1_valid_deklaracja_osoba_fizyczna.xml", DisplayName = "JPK_V7M(1) - With deklaracja; osoba fizyczna")]
        [DataRow(false, false, true, false, "TestFiles/jpk_v7m1_valid_sprzedaz_osoba_niefizyczna.xml", DisplayName = "JPK_V7M(1) - With sprzedaz; osoba niefizyczna")]
        [DataRow(true, false, true, false, "TestFiles/jpk_v7m1_valid_sprzedaz_osoba_fizyczna.xml", DisplayName = "JPK_V7M(1) - With sprzedaz; osoba fizyczna")]
        [DataRow(false, true, true, false, "TestFiles/jpk_v7m1_valid_deklaracja_sprzedaz_osoba_niefizyczna.xml", DisplayName = "JPK_V7M(1) - With deklaracja, sprzedaz; osoba niefizyczna")]
        [DataRow(true, true, true, false, "TestFiles/jpk_v7m1_valid_deklaracja_sprzedaz_osoba_fizyczna.xml", DisplayName = "JPK_V7M(1) - With deklaracja, sprzedaz; osoba fizyczna")]
        [DataRow(false, false, false, true, "TestFiles/jpk_v7m1_valid_zakupy_osoba_niefizyczna.xml", DisplayName = "JPK_V7M(1) - With zakupy; osoba niefizyczna")]
        [DataRow(true, false, false, true, "TestFiles/jpk_v7m1_valid_zakupy_osoba_fizyczna.xml", DisplayName = "JPK_V7M(1) - With zakupy; osoba fizyczna")]
        [DataRow(false, true, false, true, "TestFiles/jpk_v7m1_valid_deklaracja_zakupy_osoba_niefizyczna.xml", DisplayName = "JPK_V7M(1) - With deklaracja, zakupy; osoba niefizyczna")]
        [DataRow(true, true, false, true, "TestFiles/jpk_v7m1_valid_deklaracja_zakupy_osoba_fizyczna.xml", DisplayName = "JPK_V7M(1) - With deklaracja, zakupy; osoba fizyczna")]
        [DataRow(false, false, true, true, "TestFiles/jpk_v7m1_valid_sprzedaz_zakupy_osoba_niefizyczna.xml", DisplayName = "JPK_V7M(1) - With sprzedaz, zakupy; osoba niefizyczna")]
        [DataRow(true, false, true, true, "TestFiles/jpk_v7m1_valid_sprzedaz_zakupy_osoba_fizyczna.xml", DisplayName = "JPK_V7M(1) - With sprzedaz, zakupy; osoba fizyczna")]
        [DataRow(false, true, true, true, "TestFiles/jpk_v7m1_valid_deklaracja_sprzedaz_zakupy_osoba_niefizyczna.xml", DisplayName = "JPK_V7M(1) - With deklaracja, sprzedaz, zakupy; osoba niefizyczna")]
        [DataRow(true, true, true, true, "TestFiles/jpk_v7m1_valid_deklaracja_sprzedaz_zakupy_osoba_fizyczna.xml", DisplayName = "JPK_V7M(1) - With deklaracja, sprzedaz, zakupy; osoba fizyczna")]
        [Description("Checks if JPK_V7M(1) files are generated properly.")]
