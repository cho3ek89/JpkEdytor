namespace JpkEdytor.Tests.ViewModelTests
{
    ...
    using JpkEdytor.Models.V71.V7K;
    ...
    {
        [DataTestMethod]
        [DataRow(false, false, false, false, "TestFiles/jpk_v7k1_valid_empty_osoba_niefizyczna.xml", DisplayName = "JPK_V7K(1) - Empty; osoba niefizyczna")]
        [DataRow(true, false, false, false, "TestFiles/jpk_v7k1_valid_empty_osoba_fizyczna.xml", DisplayName = "JPK_V7K(1) - Empty; osoba fizyczna")]
        [DataRow(false, true, false, false, "TestFiles/jpk_v7k1_valid_deklaracja_osoba_niefizyczna.xml", DisplayName = "JPK_V7K(1) - With deklaracja; osoba niefizyczna")]
        [DataRow(true, true, false, false, "TestFiles/jpk_v7k1_valid_deklaracja_osoba_fizyczna.xml", DisplayName = "JPK_V7K(1) - With deklaracja; osoba fizyczna")]
        [DataRow(false, false, true, false, "TestFiles/jpk_v7k1_valid_sprzedaz_osoba_niefizyczna.xml", DisplayName = "JPK_V7K(1) - With sprzedaz; osoba niefizyczna")]
        [DataRow(true, false, true, false, "TestFiles/jpk_v7k1_valid_sprzedaz_osoba_fizyczna.xml", DisplayName = "JPK_V7K(1) - With sprzedaz; osoba fizyczna")]
        [DataRow(false, true, true, false, "TestFiles/jpk_v7k1_valid_deklaracja_sprzedaz_osoba_niefizyczna.xml", DisplayName = "JPK_V7K(1) - With deklaracja, sprzedaz; osoba niefizyczna")]
        [DataRow(true, true, true, false, "TestFiles/jpk_v7k1_valid_deklaracja_sprzedaz_osoba_fizyczna.xml", DisplayName = "JPK_V7K(1) - With deklaracja, sprzedaz; osoba fizyczna")]
        [DataRow(false, false, false, true, "TestFiles/jpk_v7k1_valid_zakupy_osoba_niefizyczna.xml", DisplayName = "JPK_V7K(1) - With zakupy; osoba niefizyczna")]
        [DataRow(true, false, false, true, "TestFiles/jpk_v7k1_valid_zakupy_osoba_fizyczna.xml", DisplayName = "JPK_V7K(1) - With zakupy; osoba fizyczna")]
        [DataRow(false, true, false, true, "TestFiles/jpk_v7k1_valid_deklaracja_zakupy_osoba_niefizyczna.xml", DisplayName = "JPK_V7K(1) - With deklaracja, zakupy; osoba niefizyczna")]
        [DataRow(true, true, false, true, "TestFiles/jpk_v7k1_valid_deklaracja_zakupy_osoba_fizyczna.xml", DisplayName = "JPK_V7K(1) - With deklaracja, zakupy; osoba fizyczna")]
        [DataRow(false, false, true, true, "TestFiles/jpk_v7k1_valid_sprzedaz_zakupy_osoba_niefizyczna.xml", DisplayName = "JPK_V7K(1) - With sprzedaz, zakupy; osoba niefizyczna")]
        [DataRow(true, false, true, true, "TestFiles/jpk_v7k1_valid_sprzedaz_zakupy_osoba_fizyczna.xml", DisplayName = "JPK_V7K(1) - With sprzedaz, zakupy; osoba fizyczna")]
        [DataRow(false, true, true, true, "TestFiles/jpk_v7k1_valid_deklaracja_sprzedaz_zakupy_osoba_niefizyczna.xml", DisplayName = "JPK_V7K(1) - With deklaracja, sprzedaz, zakupy; osoba niefizyczna")]
        [DataRow(true, true, true, true, "TestFiles/jpk_v7k1_valid_deklaracja_sprzedaz_zakupy_osoba_fizyczna.xml", DisplayName = "JPK_V7K(1) - With deklaracja, sprzedaz, zakupy; osoba fizyczna")]
        [Description("Checks if JPK_V7K(1) files are generated properly.")]
        ...
        {
            jpk.Naglowek.DataWytworzeniaJpk = new DateTime(2020, 9, 21);
            jpk.Naglowek.NazwaSystemu = "JpkEdytor";
            jpk.Naglowek.Rok = "2020";
            jpk.Naglowek.Miesiac = 9;
        }
        ...
        private void AppendSprzedaz(Jpk jpk)
        {
            ...
            //row08: with BSpv, BSpvDostawa, BMpvProwizja, Mpp
            ...
            //row09: with KorektaPodstawyOpodatkowania
        ...
        private void AppendZakupy(Jpk jpk)
        {
            ...
            r03.DataWplywu = new DateTime(2020, 4, 28);
            ...
            r07.K40 = (decimal)167.07;

            //row08: with K40, K41
            var r08 = GetZakupWierszTemplate();
            r08.K41 = (decimal)167.08;

            //row09: with K42, K43
            var r09 = GetZakupWierszTemplate();
            r09.K42 = (decimal)167.09;

            //row10: with K42, K43
            var r10 = GetZakupWierszTemplate();
            r10.K43 = (decimal)167.10;

            //row11: with K44
            var r11 = GetZakupWierszTemplate();
            r11.K44 = (decimal)167.11;

            //row12: with K45
            var r12 = GetZakupWierszTemplate();
            r12.K45 = (decimal)167.12;

            //row13: with K46
            var r13 = GetZakupWierszTemplate();
            r13.K46 = (decimal)167.13;

            //row14: with ZakupVatMarza
            var r14 = GetZakupWierszTemplate();
            r14.K47 = (decimal)167.14;

            //row15: with K47
            var r15 = GetZakupWierszTemplate();
            r15.ZakupVatMarza = (decimal)167.15;

            //row20: with all specified fields
            var r16 = GetZakupWierszTemplate();
            r16.KodKrajuNadaniaTin = "PL";
            r16.DataWplywu = new DateTime(2020, 4, 28);
            r16.DokumentZakupu = DokumentZakupu.VatRr;
            r16.Mpp = 1;
            r16.Imp = 1;
            r16.K40 = (decimal)167.16;
            r16.K41 = (decimal)167.16;
            r16.K42 = (decimal)167.16;
            r16.K43 = (decimal)167.16;
            r16.K44 = (decimal)167.16;
            r16.K45 = (decimal)167.16;
            r16.K46 = (decimal)167.16;
            r16.K47 = (decimal)167.16;
            r16.ZakupVatMarza = (decimal)167.16;
        ...
        private EwidencjaSprzedazWiersz GetSprzedazWierszTemplate()
        {
            var sprzedazWiersz = new EwidencjaSprzedazWiersz
            {
                ...
                DataWystawienia = new DateTime(2020, 4, 23),
            };
        ...
        private EwidencjaZakupWiersz GetZakupWierszTemplate()
        {
            var zakupWiersz = new EwidencjaZakupWiersz
            {
                ...
                DataZakupu = new DateTime(2020, 5, 17),
            };
