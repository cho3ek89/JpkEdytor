namespace JpkEdytor.Tests.ViewModelTests
{
    ...
    {
        [DataTestMethod]
        [DataRow(false, false, false, false, "TestFiles/jpk_mag1_valid_empty.xml", DisplayName = "JPK_MAG(1) - Empty")]
        [DataRow(false, false, false, true, "TestFiles/jpk_mag1_valid_mm.xml", DisplayName = "JPK_MAG(1) - MM")]
        [DataRow(false, false, true, false, "TestFiles/jpk_mag1_valid_rw.xml", DisplayName = "JPK_MAG(1) - RW")]
        [DataRow(false, false, true, true, "TestFiles/jpk_mag1_valid_rw_mm.xml", DisplayName = "JPK_MAG(1) - RM, MM")]
        [DataRow(false, true, false, false, "TestFiles/jpk_mag1_valid_wz.xml", DisplayName = "JPK_MAG(1) - WZ")]
        [DataRow(false, true, false, true, "TestFiles/jpk_mag1_valid_wz_mm.xml", DisplayName = "JPK_MAG(1) - WZ, MM")]
        [DataRow(false, true, true, false, "TestFiles/jpk_mag1_valid_wz_rw.xml", DisplayName = "JPK_MAG(1) - WZ, RW")]
        [DataRow(false, true, true, true, "TestFiles/jpk_mag1_valid_wz_rw_mm.xml", DisplayName = "JPK_MAG(1) - WZ, RW, MM")]
        [DataRow(true, false, false, false, "TestFiles/jpk_mag1_valid_pz.xml", DisplayName = "JPK_MAG(1) - PZ")]
        [DataRow(true, false, false, true, "TestFiles/jpk_mag1_valid_pz_mm.xml", DisplayName = "JPK_MAG(1) - PZ, MM")]
        [DataRow(true, false, true, false, "TestFiles/jpk_mag1_valid_pz_rw.xml", DisplayName = "JPK_MAG(1) - PZ, RW")]
        [DataRow(true, false, true, true, "TestFiles/jpk_mag1_valid_pz_rw_mm.xml", DisplayName = "JPK_MAG(1) - PZ, RW, MM")]
        [DataRow(true, true, false, false, "TestFiles/jpk_mag1_valid_pz_wz.xml", DisplayName = "JPK_MAG(1) - PZ, WZ")]
        [DataRow(true, true, false, true, "TestFiles/jpk_mag1_valid_pz_wz_mm.xml", DisplayName = "JPK_MAG(1) - PZ, WZ, MM")]
        [DataRow(true, true, true, false, "TestFiles/jpk_mag1_valid_pz_wz_rw.xml", DisplayName = "JPK_MAG(1) - PZ, WZ, RW")]
        [DataRow(true, true, true, true, "TestFiles/jpk_mag1_valid_pz_wz_rw_mm.xml", DisplayName = "JPK_MAG(1) - PZ, WZ, RW, MM")]
        [Description("Checks if JPK_MAG(1) files are generated properly.")]
